...
const struct shader_ref pixelshaders[30] = {
    ...
    { 1, "AlphaNoShadow" },
    { 1, "DetailMacroAS" },
    { 1, "NormalMapSpecularMap" },
    { 1, "NormalMapDetailSpecularMap" },
    { 2, "NormalMapMacroASSpecularMap" },
    { 2, "NormalMapDetailMacroASSpecularMap" },
    { 2, "NormalMapSpecularDIMap" },
    { 2, "NormalMapDetailSpecularDIMap" },
    { 2, "NormalMapMacroASSpecularDIMap" },
    { 2, "NormalMapDetailMacroASSpecularDIMap" },
    { 5, "Glass" },
    { 5, "NormalMapSpecularThrough" },
    { 5, "Grass" },
    { 6, "NormalMapThroughSimple" },
    { 102, "Super" },
    { 103, "Multi" },
    { 107, "Tree" },
    { 110, "Skin" },
