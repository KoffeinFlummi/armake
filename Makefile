...
win32:
	$(MAKE_COMMAND) $(MAKEFLAGS) CC=i686-w64-mingw32-gcc CLIBS="-I$(LIB) -lm -lcrypto -lole32 -lgdi32 -static" EXT=_w32.exe

win64:
	$(MAKE_COMMAND) $(MAKEFLAGS) CC=x86_64-w64-mingw32-gcc CLIBS="-I$(LIB) -lm -lcrypto -lole32 -lgdi32 -static" EXT=_w64.exe
